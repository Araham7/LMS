  ...
  return (
    <Layout>
      <div className=" text-white flex flex-col items-center justify-center gap-10 mx-16 min-h-[90vh]">
        <div data-theme="night" className="flex flex-col gap-5 p-2 shadow-[0_0_10px_black] w-96 rounded-lg">
          ...
          <form onSubmit={handleFormSubmit} className="flex flex-col gap-3">
            ...
            <div className="flex justify-center" >
              <button className="btn btn-primary w-60">Add Lecture</button>
            </div>
          </form>
        </div>
      </div>
